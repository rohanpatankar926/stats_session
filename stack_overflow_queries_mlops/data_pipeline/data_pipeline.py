    ...
    def dump_data(self):
        for file in os.listdir(self.file_path):
            if file.endswith(".json"):
                ...
                return None
        return "Successfully uploded data to s3 bucket"
    
if __name__=="__main__":
    DataPipeline("main_data/").preprocess_xml_data("<python>","main_data/json_data/data.json")
    DataDumpS3("main_data/json_data").dump_data()